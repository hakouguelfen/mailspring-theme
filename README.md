...
Download or clone this repository.  Open Mailspring and go to Edit -> Install Theme.  Navigate to the location of the downloaded or cloned directory and choose it.  Then go to Edit -> Change Theme and select this theme.

## Editing This Theme Or Creating Your Own
